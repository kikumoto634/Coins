...
void Tutorial04::AppInitialize(WinApp *winapp, DirectXCommon *dxCommon, Input *input, TextureManager *textureManager, GeometryManager *geometryModel, Camera *camera, DebugText *debugText, SoundManager *soundManager)
{
	this->winApp = winapp;
...
void Tutorial04::Finalize()
{
}

#pragma region コイン処理
void Tutorial04::LoadCoinPopData()
{
	//file開く
	ifstream file;
	file.open("Resources/csv/Tutorial04/CoinPopData.csv");
	assert(file.is_open());
...
void Tutorial04::UpdateCoinPopCommands()
{
	//一行分の文字列を入れる変数
	string line;
...
void Tutorial04::CoinPop(Vector3 pos)
{
...
#pragma region 壁処理
void Tutorial04::LoadWallPopData()
{
	//file開く
	ifstream file;
	file.open("Resources/csv/Tutorial04/WallPopData.csv");
	assert(file.is_open());
...
void Tutorial04::UpdateWallPopCommands()
{
	//一行分の文字列を入れる変数
	string line;
...
void Tutorial04::WallPop(Vector3 pos)
{
...
#pragma region スライド壁
void Tutorial04::LoadSlideWallPopData()
{
	//file開く
	ifstream file;
	file.open("Resources/csv/Tutorial04/SlideWallPopData.csv");
	assert(file.is_open());
...
void Tutorial04::UpdateSlideWallPopCommands()
{
	//一行分の文字列を入れる変数
	string line;
...
void Tutorial04::SlideWallPop(Vector3 pos)
{
	unique_ptr<Model> newModel = make_unique<Model>();
...
#pragma region 衝突判定
void Tutorial04::CheckAllCollision()
{
	//リストクリア
...
void Tutorial04::CheckCollisionPair(Collider *colliderA, Collider *colliderB)
{
	//衝突フィルタリング
...
bool Tutorial04::CheckCollisionDetail(Collider *colliderA, Collider *colliderB)
{
	//ボックス同士の当たり判定
...
void Tutorial04::ObjectVelocityStop()
{
	//速度設定
