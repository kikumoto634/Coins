...
void Tutorial03::AppInitialize(WinApp *winapp, DirectXCommon *dxCommon, Input *input, TextureManager *textureManager, GeometryManager *geometryModel, Camera *camera, DebugText *debugText, SoundManager *soundManager)
{
	this->winApp = winapp;
...
void Tutorial03::Finalize()
{
}

#pragma region コイン処理
void Tutorial03::LoadCoinPopData()
{
	//file開く
	ifstream file;
	file.open("Resources/csv/Tutorial03/CoinPopData.csv");
	assert(file.is_open());
...
void Tutorial03::UpdateCoinPopCommands()
{
	//一行分の文字列を入れる変数
	string line;
...
void Tutorial03::CoinPop(Vector3 pos)
{
...
#pragma region 壁処理
void Tutorial03::LoadWallPopData()
{
	//file開く
	ifstream file;
	file.open("Resources/csv/Tutorial03/ObstaclePopData.csv");
	assert(file.is_open());
...
void Tutorial03::UpdateWallPopCommands()
{
	//一行分の文字列を入れる変数
	string line;
...
void Tutorial03::WallPop(Vector3 pos)
{
...
#pragma region スライド壁
void Tutorial03::LoadSlideWallPopData()
{
	//file開く
	ifstream file;
	file.open("Resources/csv/Tutorial03/SlideWallPopData.csv");
	assert(file.is_open());
...
void Tutorial03::UpdateSlideWallPopCommands()
{
	//一行分の文字列を入れる変数
	string line;
...
void Tutorial03::SlideWallPop(Vector3 pos)
{
	unique_ptr<Model> newModel = make_unique<Model>();
...
#pragma region 衝突判定
void Tutorial03::CheckAllCollision()
{
	//リストクリア
...
void Tutorial03::CheckCollisionPair(Collider *colliderA, Collider *colliderB)
{
	//衝突フィルタリング
...
bool Tutorial03::CheckCollisionDetail(Collider *colliderA, Collider *colliderB)
{
	//ボックス同士の当たり判定
...
void Tutorial03::ObjectVelocityStop()
{
	//速度設定
