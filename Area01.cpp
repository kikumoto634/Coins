...
void Area01::AppInitialize(WinApp *winapp, DirectXCommon *dxCommon, Input *input, TextureManager *textureManager, GeometryManager *geometryModel, Camera *camera, DebugText *debugText, SoundManager *soundManager)
{
	this->winApp = winapp;
...
void Area01::Finalize()
{
}

#pragma region コイン処理
void Area01::LoadCoinPopData()
{
	//file開く
	ifstream file;
...
void Area01::UpdateCoinPopCommands()
{
	//一行分の文字列を入れる変数
	string line;
...
void Area01::CoinPop(Vector3 pos)
{
...
void Area01::UpdateWallPopCommands()
{
	//一行分の文字列を入れる変数
	string line;
...
void Area01::WallPop(Vector3 pos)
{
...
#pragma region スライド壁
void Area01::LoadSlideWallPopData()
{
	//file開く
	ifstream file;
...
void Area01::UpdateSlideWallPopCommands()
{
	//一行分の文字列を入れる変数
	string line;
...
void Area01::SlideWallPop(Vector3 pos)
{
	unique_ptr<Model> newModel = make_unique<Model>();
...
void Area01::CheckCollisionPair(Collider *colliderA, Collider *colliderB)
{
	//衝突フィルタリング
...
bool Area01::CheckCollisionDetail(Collider *colliderA, Collider *colliderB)
{
	//ボックス同士の当たり判定
...
void Area01::ObjectVelocityStop()
{
	//速度設定
