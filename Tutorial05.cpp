...
void Tutorial05::AppInitialize(WinApp *winapp, DirectXCommon *dxCommon, Input *input, TextureManager *textureManager, GeometryManager *geometryModel, Camera *camera, DebugText *debugText, SoundManager *soundManager)
{
	this->winApp = winapp;
...
void Tutorial05::Finalize()
{
}

#pragma region コイン処理
void Tutorial05::LoadCoinPopData()
{
	//file開く
	ifstream file;
	file.open("Resources/csv/Area01_coinPop.csv");
	assert(file.is_open());
...
void Tutorial05::UpdateCoinPopCommands()
{
	//一行分の文字列を入れる変数
	string line;
...
void Tutorial05::CoinPop(Vector3 pos)
{
...
#pragma region 壁処理
void Tutorial05::LoadWallPopData()
{
	//file開く
	ifstream file;
	file.open("Resources/csv/Area01_obstaclePop.csv");
	assert(file.is_open());
...
void Tutorial05::UpdateWallPopCommands()
{
	//一行分の文字列を入れる変数
	string line;
...
void Tutorial05::WallPop(Vector3 pos)
{
...
#pragma region スライド壁
void Tutorial05::LoadSlideWallPopData()
{
	//file開く
	ifstream file;
	file.open("Resources/csv/Area01_slideWall.csv");
	assert(file.is_open());
...
void Tutorial05::UpdateSlideWallPopCommands()
{
	//一行分の文字列を入れる変数
	string line;
...
void Tutorial05::SlideWallPop(Vector3 pos)
{
	unique_ptr<Model> newModel = make_unique<Model>();
...
#pragma region 衝突判定
void Tutorial05::CheckAllCollision()
{
	//リストクリア
...
void Tutorial05::CheckCollisionPair(Collider *colliderA, Collider *colliderB)
{
	//衝突フィルタリング
...
bool Tutorial05::CheckCollisionDetail(Collider *colliderA, Collider *colliderB)
{
	//ボックス同士の当たり判定
...
void Tutorial05::ObjectVelocityStop()
{
	//速度設定
