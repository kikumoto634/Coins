...
void Tutorial02::AppInitialize(WinApp *winapp, DirectXCommon *dxCommon, Input *input, TextureManager *textureManager, GeometryManager *geometryModel, Camera *camera, DebugText *debugText, SoundManager *soundManager)
{
	this->winApp = winapp;
...
void Tutorial02::Finalize()
{
}

#pragma region コイン処理
void Tutorial02::LoadCoinPopData()
{
	//file開く
	ifstream file;
	file.open("Resources/csv/Tutorial02/CoinPopData.csv");
	assert(file.is_open());
...
void Tutorial02::UpdateCoinPopCommands()
{
	//一行分の文字列を入れる変数
	string line;
...
void Tutorial02::CoinPop(Vector3 pos)
{
...
#pragma region 壁処理
void Tutorial02::LoadWallPopData()
{
	//file開く
	ifstream file;
	file.open("Resources/csv/Tutorial02/ObstaclePopData.csv");
	assert(file.is_open());
...
void Tutorial02::UpdateWallPopCommands()
{
	//一行分の文字列を入れる変数
	string line;
...
void Tutorial02::WallPop(Vector3 pos)
{
...
#pragma region 衝突判定
void Tutorial02::CheckAllCollision()
{
	//リストクリア
...
void Tutorial02::CheckCollisionPair(Collider *colliderA, Collider *colliderB)
{
	//衝突フィルタリング
...
bool Tutorial02::CheckCollisionDetail(Collider *colliderA, Collider *colliderB)
{
	//ボックス同士の当たり判定
...
void Tutorial02::ObjectVelocityStop()
{
	//速度設定
